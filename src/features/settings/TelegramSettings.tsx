  ...
  return (
    <div className='space-y-6 animate-fadeIn'>
      <div className='space-y-4'>
        ...
        <Card className='space-y-3.5 text-sm'>
          <div className='flex gap-2.5 items-start text-m3-primary'>
            <Info className='h-4 w-4 mt-0.5 shrink-0' />
            <span className='font-semibold text-xs tracking-wider uppercase'>How to set up your Telegram Bot:</span>
          </div>
          <ol className='list-decimal list-inside space-y-2 text-m3-on-surface-variant text-xs leading-relaxed pl-1.5'>
            <li>
              Open Telegram and search for{" "}
              <a href="https://t.me/BotFather" target="_blank" rel="noreferrer" className="text-m3-primary hover:underline inline-flex items-center gap-0.5">
                @BotFather <ExternalLink className="h-3 w-3" />
              </a>.
            </li>
            <li>
              Send the command <code className='px-1.5 py-0.5 rounded bg-m3-surface-container-high font-mono text-m3-on-surface border border-m3-outline-variant font-bold'>/newbot</code> and follow the instructions to name your bot.
            </li>
            <li>
          ...
          <div className='pt-1.5 flex items-center gap-1 text-[11px] text-m3-primary hover:underline select-none cursor-pointer'>
        ...
        {isEnabled && (
          <Card className='space-y-6 pt-4 animate-fadeIn shadow-sm'>
